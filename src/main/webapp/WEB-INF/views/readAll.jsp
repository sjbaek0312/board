...
<script src="<%=request.getContextPath() %>/resources/js/readAll.js"></script>
</head>
...
<br>
	...
	<button class="headbutton" type="button" onClick="location.href='/post/readMy'">내 게시물 보기</button>
...
<div class="body" id="posts">
	<c:forEach items="${readAll }" var="postVO">
		<br>
		<table width="550px">
			<tr>
			<td valign="top">
