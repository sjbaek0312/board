...
<div class="body">
	<table>
		<tr>
		<th>post_id</th><th>post_regdate</th><th>post_updatedate</th><th>title</th><th>post_content</th>
		</tr>
		<tr>
		<th>user_id</th><th>filename</th><th>post_heart</th><th>post_replycount</th><th>post_flag</th>
		</tr>
		<c:forEach items="${posts }" var="posts">
			...
			<td>${posts.title }</td><td>${posts.postContent }</td>
			</tr>
			<tr>
			<td>${posts.userId }</td><td>${posts.filename }</td>
			<td>${posts.postHeart }</td><td>${posts.postReplycount }</td><td>${posts.postFlag }</td>
			</tr>
			<tr>
			<td>
