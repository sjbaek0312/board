...
<div class="body">
	<table>
		...
		<tr>
		<th>user_id</th><th>user_pw</th><th>user_name</th><th>email</th><th>user_regdate</th><th>user_flag</th>
		</tr>
		<c:forEach items="${users }" var="users">
			<tr>
			<td>${users.userId }</td><td>${users.userPw }</td><td>${users.userName }</td><td>${users.email }</td>
